            ...
            return (
              <SidebarMenuItem key={item.title}>
                <SidebarMenuButton
                  ...
                  tooltip={item.title}
                  size="lg"
                  className="relative h-11 rounded-lg px-3 text-[0.92rem] font-medium tracking-[-0.01em] transition-all duration-150 ease-out data-active:bg-sidebar-accent data-active:text-sidebar-accent-foreground data-active:shadow-xs hover:translate-x-0.5 active:scale-[0.99]"
